                ...
                <div className='flex flex-col md:flex-row gap-6'>
                    ...
                    <div className='w-full md:w-[40%] items-center flex justify-center container mx-auto'>
                        <div className='py-10 px-4 md:pl-10 lg:pl-20 md:ml-10 lg:ml-18'>
                            <h2 className='font-medium md:text-[110px] md:leading-[90px] text-5xl text-dark'>
                                Better than<br />
                                <span className='font-light md:text-[70px] md:leading-[80px] text-3xl text-dark'>Soap & Gel wash</span>
                            </h2>
