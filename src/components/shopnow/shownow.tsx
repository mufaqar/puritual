...
function Shownow() {
  return (
    <div>
       {/* Shop Now button */}
            <div className="absolute right-4 sm:right-8 md:right-16 lg:right-24 xl:right-60 top-[70%] sm:top-[75%] -translate-y-1/2 w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48">
